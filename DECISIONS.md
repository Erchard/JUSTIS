...
| D-012 | 2026-04-26 | Метаблок сесії | Кожна сесія має містити короткий метаблок для перевірки якості методу, процесу, представленості голосів, незнятих заперечень і потреби в покращеннях. Ратифіковано D-024. | consensus_plenus | deliberatio_plena | `protocols/2026-04-27_D-012_session-metablock-ratification.md` |
...
| D-026 | 2026-04-27 | Закон 2: Гідність | Другий запис Кодексу: людину не можна зводити до користі, ресурсу, ролі або засобу для чужої мети. | consensus_limitatus | deliberatio_plena | `protocols/2026-04-27_Q-002_human-dignity-not-reducible-to-utility.md` |
| D-027 | 2026-04-27 | Закон 3: Сила і право | Третій запис Кодексу: сила сама по собі не створює права. | consensus_limitatus | deliberatio_plena | `protocols/2026-04-27_Q-004_force-and-right.md` |
| D-028 | 2026-04-27 | Закон 4: Однакові випадки | Четвертий запис Кодексу: релевантно однакові випадки мають оцінюватися однаково; різне ставлення потребує публічно виправданої морально релевантної підстави. | consensus_limitatus | deliberatio_plena | `protocols/2026-04-27_Q-003_equal-cases-consistency.md` |
