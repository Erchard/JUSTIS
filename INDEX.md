...
Обидва мають статус `consensus_limitatus`, тобто вони прийняті як робочі закони, але мають зафіксовані умови перегляду.
...
Причина: Q-001 і Q-002 вже внесені в Кодекс, а питання сили й права є наступною фундаментальною аксіомою.
